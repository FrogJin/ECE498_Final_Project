...
staticGyr = csvread('Ex_4.5m_8Steps/Static/Gyroscope.csv');
biasGyro = mean(staticGyr(:, 2:4));

Acc_1 = csvread('Ex_4.5m_8Steps/Bias/Pos1/Accelerometer.csv');
ax1 = mean(Acc_1(:,2)); ay1 = mean(Acc_1(:,3)); az1 = mean(Acc_1(:,4));
Acc_2 = csvread('Ex_4.5m_8Steps/Bias/Pos2/Accelerometer.csv');
ax2 = mean(Acc_2(:,2)); ay2 = mean(Acc_2(:,3)); az2 = mean(Acc_2(:,4));
Acc_3 = csvread('Ex_4.5m_8Steps/Bias/Pos3/Accelerometer.csv');
ax3 = mean(Acc_3(:,2)); ay3 = mean(Acc_3(:,3)); az3 = mean(Acc_3(:,4));
Acc_4 = csvread('Ex_4.5m_8Steps/Bias/Pos4/Accelerometer.csv');
ax4 = mean(Acc_4(:,2)); ay4 = mean(Acc_4(:,3)); az4 = mean(Acc_4(:,4));
Acc_5 = csvread('Ex_4.5m_8Steps/Bias/Pos5/Accelerometer.csv');
ax5 = mean(Acc_5(:,2)); ay5 = mean(Acc_5(:,3)); az5 = mean(Acc_5(:,4));
Acc_6 = csvread('Ex_4.5m_8Steps/Bias/Pos6/Accelerometer.csv');
